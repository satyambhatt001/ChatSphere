    ...
    return (
        ...
        <main className='h-screen w-screen flex'>
            <section className="left relative flex flex-col h-screen min-w-96 bg-slate-300">
                ...
                <div className={`sidePanel w-full h-full flex flex-col gap-2 bg-slate-50 absolute transition-all ease-in duration-300 ${isSidePanelOpen ? 'translate-x-0' : '-translate-x-full'} top-0`}>
                    ...
                    <div className="top flex justify-between w-full">
                        ...
                        <div className="actions flex gap-2">
                            <button
                                ...
                                className='p-2 px-4 bg-slate-300 text-white rounded-md transition duration-300 ease-in-out transform hover:bg-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 max-w-max'
                            >
                                Run
                            </button>
